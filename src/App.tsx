...
import { ConfirmProvider } from './features/ui/ConfirmProvider';
...
export default function App() {
  ...
  return <BrowserRouter><AuthProvider><ConfirmProvider><RouteAnalytics /><Suspense fallback={<div className="min-h-screen grid place-items-center font-display font-black">{t('common.loadingStudio')}</div>}><Routes>
  ...
  </Routes></Suspense></ConfirmProvider></AuthProvider></BrowserRouter>;
}
